...
import type { RebalanceSchedule, RebalanceFrequency } from "@/slate/slate-engine";
...
export default function SimControls({
  ...
  /** The creator-set initial slate value (from the Set the Slates page). */
  baseValue: number;
  ...
  return (
    <div className="rounded-lg border border-zinc-700 bg-zinc-900/50 p-3 mb-4 flex items-center gap-x-5 gap-y-2 flex-wrap text-xs">
      ...
      <div className="flex items-center gap-2" title="Set on the Set the Slates page; applied when the sim is (re)seeded">
        <span className="text-[10px] uppercase tracking-wide text-zinc-500">Launch value</span>
